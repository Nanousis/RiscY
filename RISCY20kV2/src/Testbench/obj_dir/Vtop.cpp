...
Vtop::Vtop(VerilatedContext* _vcontextp__, const char* _vcname__)
    ...
    , clk{vlSymsp->TOP.clk}
    , LCD_CLK{vlSymsp->TOP.LCD_CLK}
    , LCD_HYNC{vlSymsp->TOP.LCD_HYNC}
    , LCD_SYNC{vlSymsp->TOP.LCD_SYNC}
    , LCD_DEN{vlSymsp->TOP.LCD_DEN}
    , LCD_R{vlSymsp->TOP.LCD_R}
    , LCD_G{vlSymsp->TOP.LCD_G}
    , LCD_B{vlSymsp->TOP.LCD_B}
    , flashMiso{vlSymsp->TOP.flashMiso}
    , flashClk{vlSymsp->TOP.flashClk}
    , flashMosi{vlSymsp->TOP.flashMosi}
    , flashCs{vlSymsp->TOP.flashCs}
    , uart_rx{vlSymsp->TOP.uart_rx}
    , uart_tx{vlSymsp->TOP.uart_tx}
    , btnDownL{vlSymsp->TOP.btnDownL}
    , btnUpL{vlSymsp->TOP.btnUpL}
    , btnLeftL{vlSymsp->TOP.btnLeftL}
    , btnRightL{vlSymsp->TOP.btnRightL}
    , btnDownR{vlSymsp->TOP.btnDownR}
    , btnUpR{vlSymsp->TOP.btnUpR}
    , btnLeftR{vlSymsp->TOP.btnLeftR}
    , btnRightR{vlSymsp->TOP.btnRightR}
    , rootp{&(vlSymsp->TOP)}
{
