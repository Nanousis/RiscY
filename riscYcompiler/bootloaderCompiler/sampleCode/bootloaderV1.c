...
int main() {
    ...
    while(1){
        ...
        magicNumRead[9]="\0\0\0\0\0\0\0\0\0";
        ...
        magicNumRead[3] = readData & 0xFF;
        magicNumRead[2] = (readData >> 8) & 0xFF;
        magicNumRead[1] = (readData >> 16) & 0xFF;
        magicNumRead[0] = (readData >> 24) & 0xFF;
        tempAddress += 4;
        readData = readFlash(tempAddress);
        magicNumRead[7] = readData & 0xFF;
        magicNumRead[6] = (readData >> 8) & 0xFF;
        magicNumRead[5] = (readData >> 16) & 0xFF;
        magicNumRead[4] = (readData >> 24) & 0xFF;
        tempAddress += 4;
        for(int i=0; i<8; i++){
